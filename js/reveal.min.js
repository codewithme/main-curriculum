...
var codeEl = $('.show-html');

$.each(codeEl, function(k,v){
	v.innerHTML = escapeHTML(v.innerHTML);
})

// So in the notes view, we don't have to push through invisible fragments
if ($('body').hasClass('annotated')){
	$.each($('.disappear .fragment'), function(k,v){
		$(v).removeClass('fragment');
	})
}
